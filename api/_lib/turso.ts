...
function encodeArg(arg: unknown): HranaValue {
...
function decodeValue(raw: any): unknown {
...
function rowsToObjects(cols: Array<{ name?: string }>, rows: any[][]): Array<Record<string, unknown>> {
...
export function tursoClient() {
  ...
  return {
    async execute(stmtOrSql: ExecuteInput, args?: unknown[]) {
